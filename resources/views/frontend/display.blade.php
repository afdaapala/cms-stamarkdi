@extends('frontend.layout.display')
...
@section('content')
{{-- <div class="container"> --}}
    <div class="border border-rounded border-dark" id="map" style="width:100%; height:100%; min-height: 720px; max-height: 1080px"></div>

{{-- </div> --}}

    <!-- <div id="watermark">created by: afdaapala</div> -->
    ...
    <script>
        ...
        L.LogoControl = L.Control.extend({
            ...
            onAdd: function(map) {
                ...
                button.innerHTML = '<img width="80%" style="max-width:700px" class="logo-control-img" src="{{ url('img/kdi-display.png') }}">';
